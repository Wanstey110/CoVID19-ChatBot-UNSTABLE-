...
def main():
        ...
        #old growthrate
         ...
         #   answer = "Here is a graph showing the estimated growth rate of the SARS-CoV-2 virus"
          #  growthRate.showGraph()
            ...
            answer = """
            Try these commmands:
            growthrate + your country (takes a while)
            deathrate + your country (takes a while)
            symptomscheck
            update + your country
            updateworld
            ...
            if gc == 'usa' or gc == 'u.s.a.' or gc=='us' or gc =='u.s.':
                graph('us')
            
            elif gc == 'bosinaandherzegovina' or gc == 'growthratebosina':
                graph('bosina and herzegovina')

            elif gc == 'sanmarino':
                graph('san marino')

            elif gc == 'vatican' or gc == 'vaticancity':
                graph('vatican city')

            elif gc == 'costarica':
                graph('costa rica')

            elif gc == 'dominicanrepublic':
                graph('dominican republic')

            elif gc == 'southafrica':
                graph("south africa")
                
            elif gc == 'centralafricanrepublic':
                graph("central african republic")

            elif gc == "trinidad" or gc == "trinidadandtobago" or gc == "tobago":
                graph("trinidad and tobago")

            elif gc == "southkorea" or gc == "s.korea" or gc == "korea,south":
                graph("korea, south")
            ...
            elif gc == "uae" or gc == "unitedarabemirates" or gc == "emirates":
                graph("united arab emirates")

            elif gc == "saudiarabia" or gc == "arabia" or gc == "saudi":
                graph("saudi arabia")

            elif gc == "equatorialguinea":
                graph("equatorial guinea")
            else:
                answer = f"Here is a graph of the growth rate of the CoVID-19 virus in the country: {gc}"
                graph(gc)

        elif 'deathrate' in chat:
            gb = chat.replace('deathrate', '')
            
            if gb == 'bosinaandherzegovina' or chat == 'bosina':
            ...
            elif gb == 'vatican' or gb == 'vaticancity':
                death('vatican city')

            elif gb == 'costarica':
                death('costa rica')

            elif gb == 'dominicanrepublic':
                death('dominican republic')

            elif gb == 'southafrica':
                death("south africa")
                
            elif gb == 'Central African Republic':
                death("central african republic")

            elif gb == "trinidad" or gb == "trinidadandtobago" or gb == "tobago":
                death("trinidad and tobago")

            elif gb == "southkorea" or gb == "s.korea" or gb == "korea,south":
                death("korea, south")
            ...
            elif gb == "uae" or gb == "unitedarabemirates" or gb == "emirates":
                death("united arab emirates")

            elif gb == "saudiarabia" or gb == "arabia" or gb == "saudi":
                death("saudi arabia")

            elif gb == "equatorialguinea":
                death("equatorial guinea")
            else:
                answer = f"Here is a graph of the death rate of the CoVID-19 virus in the country: {gb}"
                death(gb)
    ...
    getResponse("""
        ...
        symptom checker
        growthrate + country (It may take a few minutes to load)
        deathrate + country (It may take a few minutes to load)
